/// Money is ALWAYS an int in paise inside BankEase App
/// These helper are the only place we convert to and from rupees
...
/// Indian Grouping: last three digits, then groups of two digits -> 12345678 -> 1,23,45,678
...
/// Parses user input such as '49.8' or '1,000' into paise without using doubles
